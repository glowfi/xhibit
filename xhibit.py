...
class xhibit:
    ...
    def ascii_art(self):
        ...
        def fairy():
            ...
            print(tcolor(f" |       \  \    ,-.)  -= * =-    * {self.info[0]}     ",color=self.field_colors[2],styles=["bold"]))
            print(tcolor(f"  \ /\_   '. \((` .(    '/. '     * {self.info[1]}     ",color=self.field_colors[0],styles=["bold"]))
            print(tcolor(f"   )\ /     \ )\  _/   _/         * {self.info[2]}     ",color=self.field_colors[1],styles=["bold"]))
